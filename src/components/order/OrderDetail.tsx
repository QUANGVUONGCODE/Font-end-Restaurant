...
const OrderDetailModal: React.FC<OrderDetailModalProps> = ({
  ...
  // fetch khi mở modal hoặc đổi orderId
  useEffect(() => {
            ...
            {loading ? (
              ...
              <>
                ...
                {headerInfo && (
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div className="p-4 rounded-xl border border-gray-100">
                      ...
                      <p className="font-semibold text-gray-900">
                        {formatDateTimeVN(headerInfo.orderDate)}
                      </p>
                ...
                <div className="space-y-4">
                  {items.map((it) => {
                    const thumb = it.food?.thumbnail
                      ? `${FOOD_IMG_BASE}${it.food.thumbnail}`
                      : '';
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
                            <div>
                              ...
                              <p className="text-sm text-gray-600">
                                {it.food?.description || 'Không có mô tả'}
                              </p>
                              {it.food?.category?.name && (
                                <p className="text-xs text-gray-500 mt-1">
                                  Danh mục: {it.food.category.name}
                                </p>
                              )}
                            </div>
                          ...
                          <div className="mt-3 flex items-center justify-between">
                            ...
                            <p className="text-sm text-gray-600">
                              ...
                              <span className="font-bold text-gray-900">
                                {it.total_money?.toLocaleString('vi-VN')} đ
                              </span>
                            </p>
                          </div>
                        </div>
